...
require (
	...
	github.com/go-skynet/go-llama.cpp v0.0.0-20230727163958-6ba16de8e965
	...
	github.com/nomic-ai/gpt4all/gpt4all-bindings/golang v0.0.0-20230727161923-39acbc837816
