...
func (e *embedBackend) AudioTranscription(ctx context.Context, in *pb.TranscriptRequest, opts ...grpc.CallOption) (*schema.WhisperResult, error) {
	r, err := e.s.AudioTranscription(ctx, in)
	if err != nil {
		return nil, err
	}
	tr := &schema.WhisperResult{}
