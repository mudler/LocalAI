...
type RunCMD struct {
	...
	SingleActiveBackend                bool     `env:"LOCALAI_SINGLE_ACTIVE_BACKEND,SINGLE_ACTIVE_BACKEND" help:"Allow only one backend to be run at a time (DEPRECATED since v2.0.0, removed in v3.0.0: use --max-active-backends=1 instead)" group:"backends"`
