...
const (
	StateResponse_UNINITIALIZED StateResponse_State = 0
	StateResponse_BUSY          StateResponse_State = 1
	StateResponse_READY         StateResponse_State = 2
	StateResponse_ERROR         StateResponse_State = -1
)
...
type StateResponse struct {
	...
	State  StateResponse_State `protobuf:"varint,1,opt,name=state,proto3,enum=backend.StateResponse_State" json:"state,omitempty"`
...
func (x *StateResponse) GetState() StateResponse_State {
	...
	return StateResponse_UNINITIALIZED
}

func (x *StateResponse) GetMemory() *MemoryUsageData {
	if x != nil {
		return x.Memory
	}
	return nil
...
var file_pkg_grpc_proto_backend_proto_rawDesc = []byte{
	...
	0x22, 0xba, 0x01, 0x0a, 0x0d, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x12, 0x32, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x1c, 0x2e, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2e, 0x53, 0x74, 0x61, 0x74,
	...
	0x4f, 0x52, 0x10, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x01, 0x32, 0xf2, 0x04,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x39, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65,
	0x12, 0x16, 0x2e, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74,
	0x68, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0x16, 0x2e, 0x62, 0x61, 0x63, 0x6b, 0x65,
	0x6e, 0x64, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x00, 0x42, 0x5a, 0x0a, 0x19, 0x69, 0x6f, 0x2e, 0x73, 0x6b, 0x79, 0x6e, 0x65, 0x74, 0x2e,
...
var file_pkg_grpc_proto_backend_proto_goTypes = []interface{}{
	(StateResponse_State)(0),     // 0: backend.StateResponse.State
	...
	(*StateResponse)(nil),        // 14: backend.StateResponse
...
var file_pkg_grpc_proto_backend_proto_depIdxs = []int32{
	...
	0,  // 2: backend.StateResponse.state:type_name -> backend.StateResponse.State
	13, // 3: backend.StateResponse.memory:type_name -> backend.MemoryUsageData
	...
	1,  // 13: backend.Backend.State:input_type -> backend.HealthMessage
	...
	14, // 23: backend.Backend.State:output_type -> backend.StateResponse
