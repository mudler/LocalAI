...
`,
		...
		Action: func(ctx *cli.Context) error {
			...
			return api.App(model.NewModelLoader(ctx.String("models-path")), ctx.Int("threads"), ctx.Int("context-size"), ctx.Bool("f16"), debugMode, false).Listen(ctx.String("address"))
		},
	}
