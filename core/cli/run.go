...
type RunCMD struct {
	...
	EnablePredownloadScan bool     `env:"LOCALAI_ENFORCE_PREDOWNLOAD_SCAN" help:"Runs the best-effort security scanner before downloading any files." group:"hardening" default:"true"`
