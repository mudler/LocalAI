...
require (
	...
	github.com/go-skynet/go-llama.cpp v0.0.0-20230814195654-18f25c21abf9
	...
	github.com/nomic-ai/gpt4all/gpt4all-bindings/golang v0.0.0-20230814164545-4e55940edf11
