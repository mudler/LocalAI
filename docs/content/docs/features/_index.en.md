...
- [🗣 Text to Audio]({{%relref "docs/features/text-to-audio" %}})
- [🔈 Audio to text]({{%relref "docs/features/audio-to-text" %}})
- [🎨 Image generation]({{%relref "docs/features/image-generation" %}})
- [🧠 Embeddings]({{%relref "docs/features/embeddings" %}})
- [🔥 OpenAI functions]({{%relref "docs/features/openai-functions" %}})
- [🆕 GPT Vision API]({{%relref "docs/features/gpt-vision" %}})
...
|----------------------------------------------------------------------------------|-----------------------|--------------------------|---------------------------|-----------------------------------|----------------------|--------------|
| [llama.cpp]({{%relref "docs/model-compatibility/llama-cpp" %}})        | Vicuna, Alpaca, LLaMa | yes                      | GPT and Functions                        | yes** | yes                  | CUDA, openCL, cuBLAS, Metal |
