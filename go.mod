...
require (
	...
	github.com/go-skynet/go-llama.cpp v0.0.0-20230907134149-05dc4b6210cd
	...
	github.com/nomic-ai/gpt4all/gpt4all-bindings/golang v0.0.0-20230901172141-b6e38d69eda9
