...
type ClientSession struct {
	...
	// TODO: Reference to a prompt template and its variables.
	// Prompt *PromptReference `json:"prompt,omitempty"`

	// TODO: How the model chooses tools. Provide one of the string modes or force a specific function/MCP tool.
	// ToolChoice *ToolChoiceUnion `json:"tool_choice,omitempty"`

	// TODO: Tools available to the model.
	// Tools []ToolUnion `json:"tools,omitempty"`

	// TODO: Realtime API can write session traces to the Traces Dashboard. Set to null to disable tracing. Once tracing is enabled for a session, the configuration cannot be modified.
	//
	...
	// TODO: Controls how the realtime conversation is truncated prior to model inference. The default is auto.
...
const (
	...
	ServerEventTypeTranscriptionSessionCreated                      ServerEventType = "transcription_session.created" //obsolete
	ServerEventTypeTranscriptionSessionUpdated                      ServerEventType = "transcription_session.updated" //obsolete
	ServerEventTypeConversationCreated                              ServerEventType = "conversation.created"          //obsolete
	...
	ServerEventTypeResponseTextDelta                                ServerEventType = "response.text.delta"             //obsolete
	ServerEventTypeResponseTextDone                                 ServerEventType = "response.text.done"              //obsolete
	ServerEventTypeResponseAudioTranscriptDelta                     ServerEventType = "response.audio_transcript.delta" //obsolete
	ServerEventTypeResponseAudioTranscriptDone                      ServerEventType = "response.audio_transcript.done"  //obsolete
	ServerEventTypeResponseAudioDelta                               ServerEventType = "response.audio.delta"            //obsolete
	ServerEventTypeResponseAudioDone                                ServerEventType = "response.audio.done"             //obsolete
