        ...
        "/api/operations/{jobID}/throttle": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Human-readable rate (e.g. 2mb, 500kb) or 0 to remove the limit",
                        "name": "rate",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "success and message with the applied bytes/sec rate",
                        "schema": {
                            "$ref": "#/definitions/localai.ThrottleResponse"
                        }
                    },
                    "400": {
                        "description": "missing rate, invalid rate, or unknown operation",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
