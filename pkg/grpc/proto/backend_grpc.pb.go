...
const (
	...
	Backend_UnloadModel_FullMethodName        = "/backend.Backend/UnloadModel"
...
type BackendClient interface {
	...
	UnloadModel(ctx context.Context, in *HealthMessage, opts ...grpc.CallOption) (*StatusResponse, error)
...
func (c *backendClient) UnloadModel(ctx context.Context, in *HealthMessage, opts ...grpc.CallOption) (*StatusResponse, error) {
	out := new(StatusResponse)
	err := c.cc.Invoke(ctx, Backend_UnloadModel_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BackendServer interface {
	...
	UnloadModel(context.Context, *HealthMessage) (*StatusResponse, error)
...
func (UnimplementedBackendServer) UnloadModel(context.Context, *HealthMessage) (*StatusResponse, error) {
...
func _Backend_UnloadModel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HealthMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BackendServer).UnloadModel(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Backend_UnloadModel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BackendServer).UnloadModel(ctx, req.(*HealthMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Backend_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Backend_UnloadModel_Handler,
		},
		{
