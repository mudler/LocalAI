...
var BackendCapabilities = map[string]BackendCapability{
	...
	"mlx": {
		GRPCMethods:      []GRPCMethod{MethodPredict, MethodPredictStream},
		PossibleUsecases: []string{UsecaseChat, UsecaseCompletion},
		DefaultUsecases:  []string{UsecaseChat},
	...
	"mlx-vlm": {
		GRPCMethods:      []GRPCMethod{MethodPredict, MethodPredictStream},
		PossibleUsecases: []string{UsecaseChat, UsecaseCompletion, UsecaseVision},
