...
# whisper.cpp version
WHISPER_CPP_VERSION?=ec03661b20c7d8b66348c0a439c3386b996b2b72
...
protogen-go:
	protoc --go_out=. --go_opt=paths=source_relative --go-grpc_out=. --go-grpc_opt=paths=source_relative backend/backend.proto
