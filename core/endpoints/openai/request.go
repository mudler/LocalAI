...
func updateConfig(config *datamodel.Config, input *datamodel.OpenAIRequest) {
	if input.Echo {
...
func readConfig(modelFile string, input *datamodel.OpenAIRequest, cm *backend.ConfigLoader, loader *model.ModelLoader, debug bool, threads, ctx int, f16 bool) (*datamodel.Config, *datamodel.OpenAIRequest, error) {
