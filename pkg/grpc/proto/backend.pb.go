...
var file_pkg_grpc_proto_backend_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x22, 0xe2, 0x07, 0x0a, 0x0c, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x4f, 0x70, 0x74, 0x69,
	...
	0x4c, 0x49, 0x50, 0x53, 0x6b, 0x69, 0x70, 0x22, 0x3c, 0x0a, 0x06, 0x52, 0x65, 0x73, 0x75, 0x6c,
	...
	0x18, 0x05, 0x20, 0x03, 0x28, 0x05, 0x52, 0x06, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x22, 0xbe,
	...
	0x52, 0x03, 0x64, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x73, 0x72, 0x63, 0x18, 0x09, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x73, 0x72, 0x63, 0x12, 0x2a, 0x0a, 0x10, 0x45, 0x6e, 0x61, 0x62, 0x6c,
	0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x10, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74,
	0x65, 0x72, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x43, 0x4c, 0x49, 0x50, 0x53, 0x6b, 0x69, 0x70, 0x18,
	0x0b, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x43, 0x4c, 0x49, 0x50, 0x53, 0x6b, 0x69, 0x70, 0x22,
	...
	0xb6, 0x05, 0x0a, 0x07, 0x42, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x12, 0x32, 0x0a, 0x06, 0x48,
	...
	0x65, 0x6e, 0x64, 0x2e, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x22, 0x00, 0x12, 0x40, 0x0a, 0x0b,
	0x55, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x12, 0x16, 0x2e, 0x62, 0x61,
...
var file_pkg_grpc_proto_backend_proto_depIdxs = []int32{
	...
	1,  // 7: backend.Backend.UnloadModel:input_type -> backend.HealthMessage
	2,  // 8: backend.Backend.PredictStream:input_type -> backend.PredictOptions
	2,  // 9: backend.Backend.Embedding:input_type -> backend.PredictOptions
	10, // 10: backend.Backend.GenerateImage:input_type -> backend.GenerateImageRequest
	7,  // 11: backend.Backend.AudioTranscription:input_type -> backend.TranscriptRequest
	11, // 12: backend.Backend.TTS:input_type -> backend.TTSRequest
	2,  // 13: backend.Backend.TokenizeString:input_type -> backend.PredictOptions
	1,  // 14: backend.Backend.Status:input_type -> backend.HealthMessage
	3,  // 15: backend.Backend.Health:output_type -> backend.Reply
	3,  // 16: backend.Backend.Predict:output_type -> backend.Reply
	5,  // 17: backend.Backend.LoadModel:output_type -> backend.Result
	14, // 18: backend.Backend.UnloadModel:output_type -> backend.StatusResponse
	3,  // 19: backend.Backend.PredictStream:output_type -> backend.Reply
	6,  // 20: backend.Backend.Embedding:output_type -> backend.EmbeddingResult
	5,  // 21: backend.Backend.GenerateImage:output_type -> backend.Result
	8,  // 22: backend.Backend.AudioTranscription:output_type -> backend.TranscriptResult
	5,  // 23: backend.Backend.TTS:output_type -> backend.Result
	12, // 24: backend.Backend.TokenizeString:output_type -> backend.TokenizationResponse
	14, // 25: backend.Backend.Status:output_type -> backend.StatusResponse
