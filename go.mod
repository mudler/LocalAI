...
require (
	...
	github.com/go-skynet/go-llama.cpp v0.0.0-20230724222459-562d2b5a7119
	...
	github.com/nomic-ai/gpt4all/gpt4all-bindings/golang v0.0.0-20230725212419-9100b2ef6fb9
