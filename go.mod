...
require (
	...
	github.com/go-skynet/go-llama.cpp v0.0.0-20231004160246-1676dcd7a139
	...
	github.com/nomic-ai/gpt4all/gpt4all-bindings/golang v0.0.0-20231006183842-56c0d2898dce
