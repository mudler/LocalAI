...
ifdef BUILD_GRPC_FOR_BACKEND_LLAMA
	...
	CMAKE_ARGS="${CMAKE_ARGS} ${ADDED_CMAKE_ARGS} -D_PROTOBUF_PROTOC=${_PROTOBUF_PROTOC} -D_GRPC_GRPCPP=${_GRPC_GRPCPP} -D_GRPC_CPP_PLUGIN_EXECUTABLE=${_GRPC_CPP_PLUGIN_EXECUTABLE}" LLAMA_VERSION=$(CPPLLAMA_VERSION) $(MAKE) -C backend/cpp/llama grpc-server
