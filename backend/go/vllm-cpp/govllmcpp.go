...
var (
	...
	vllmSystemone     func(engine uintptr, requestJSON string, out unsafe.Pointer) int32
	vllmSystemoneFree func(json uintptr)
	vllmScore         func(engine uintptr, requestJSON string, out unsafe.Pointer) int32
	vllmScoreFree     func(json uintptr)
)
...
func registerLib(libName string) error {
	...
	for _, lf := range []libFunc{
		...
		{&vllmSystemone, "vllm_systemone"},
		{&vllmSystemoneFree, "vllm_systemone_free"},
		{&vllmScore, "vllm_score"},
		{&vllmScoreFree, "vllm_score_free"},
	} {
