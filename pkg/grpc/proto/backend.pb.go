...
func (x *TokenizationResponse) GetTokens() []string {
	if x != nil {
		return x.Tokens
	}
	return nil
...
var file_pkg_grpc_proto_backend_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x73, 0x32, 0xb7, 0x04,
...
var file_pkg_grpc_proto_backend_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_pkg_grpc_proto_backend_proto_goTypes = []interface{}{
	...
	(*TokenizationResponse)(nil), // 11: backend.TokenizationResponse
}
var file_pkg_grpc_proto_backend_proto_depIdxs = []int32{
	...
	1,  // 9: backend.Backend.TokenizeString:input_type -> backend.PredictOptions
	2,  // 10: backend.Backend.Health:output_type -> backend.Reply
	2,  // 11: backend.Backend.Predict:output_type -> backend.Reply
	4,  // 12: backend.Backend.LoadModel:output_type -> backend.Result
	2,  // 13: backend.Backend.PredictStream:output_type -> backend.Reply
	5,  // 14: backend.Backend.Embedding:output_type -> backend.EmbeddingResult
	4,  // 15: backend.Backend.GenerateImage:output_type -> backend.Result
	7,  // 16: backend.Backend.AudioTranscription:output_type -> backend.TranscriptResult
	4,  // 17: backend.Backend.TTS:output_type -> backend.Result
	11, // 18: backend.Backend.TokenizeString:output_type -> backend.TokenizationResponse
