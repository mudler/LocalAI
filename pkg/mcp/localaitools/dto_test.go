...
var _ = Describe("DTOs round-trip through JSON", func() {
	It("preserves every field across the public DTO set", func() {
		...
		roundTripDTO(GalleryModelHit{Name: "n", Gallery: "g", URL: "u", Description: "d", License: "l", Tags: []string{"a", "b"}, Installed: true})
		roundTripDTO(InstalledModel{Name: "n", Backend: "b", Capabilities: []string{"chat"}, Pinned: true, Disabled: false})
		roundTripDTO(Gallery{Name: "n", URL: "u"})
		...
		roundTripDTO(Backend{Name: "n", Gallery: "g", Installed: true, Description: "d", Tags: []string{"x"}})
		...
		roundTripDTO(VRAMEstimate{ModelName: "m", EstimatedVRAMMB: 1024, WeightsMB: 800, KVCacheMB: 100, OverheadMB: 124})
	})
})
